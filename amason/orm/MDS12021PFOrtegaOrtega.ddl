CREATE TABLE Cantidad (Id int(10) NOT NULL AUTO_INCREMENT, ProductoId int(10) NOT NULL, PedidoId int(10) NOT NULL, Cantidad int(10) NOT NULL, PRIMARY KEY (Id)) ENGINE=InnoDB;
...
CREATE TABLE Respuesta (Id int(10) NOT NULL AUTO_INCREMENT, UsuarioId int(10) NOT NULL, MensajeId int(10) NOT NULL, Orden int(10) NOT NULL, Contendio varchar(255), PRIMARY KEY (Id)) ENGINE=InnoDB;
CREATE TABLE Mensaje (Id int(10) NOT NULL AUTO_INCREMENT, ClienteUsuarioId int(10) NOT NULL, PRIMARY KEY (Id)) ENGINE=InnoDB;
CREATE TABLE Pedido_entregado (PedidoId int(10) NOT NULL, Empresa_transportesUsuarioId int(10) NOT NULL, PRIMARY KEY (PedidoId)) ENGINE=InnoDB;
...
CREATE TABLE Valoracion (Id int(10) NOT NULL AUTO_INCREMENT, ClienteUsuarioId int(10) NOT NULL, ProductoId int(10) NOT NULL, Puntuacion int(10) NOT NULL, Comentario varchar(255), Fecha bigint(20), PRIMARY KEY (Id)) ENGINE=InnoDB;
...
CREATE TABLE Producto (Id int(10) NOT NULL AUTO_INCREMENT, OfertaId int(10), CategoriaId int(10) NOT NULL, Nombre varchar(255), Precio float NOT NULL, Activo bit(1) NOT NULL, Descripcion varchar(255), PRIMARY KEY (Id)) ENGINE=InnoDB;
...
ALTER TABLE Cantidad ADD CONSTRAINT FKCantidad556731 FOREIGN KEY (PedidoId) REFERENCES Pedido (Id);
...
ALTER TABLE Valoracion ADD CONSTRAINT FKValoracion994559 FOREIGN KEY (ClienteUsuarioId) REFERENCES Cliente (UsuarioId);
ALTER TABLE Pedido_entregado ADD CONSTRAINT FKPedido_ent545421 FOREIGN KEY (Empresa_transportesUsuarioId) REFERENCES Empresa_transportes (UsuarioId);
ALTER TABLE Respuesta ADD CONSTRAINT FKRespuesta179661 FOREIGN KEY (UsuarioId) REFERENCES Usuario (Id);
