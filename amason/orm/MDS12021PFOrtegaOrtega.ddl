...
CREATE TABLE Valoracion (Id int(10) NOT NULL AUTO_INCREMENT, ProductoId int(10) NOT NULL, Puntuacion int(10) NOT NULL, Comentario varchar(255), PRIMARY KEY (Id));
...
CREATE TABLE Producto (Id int(10) NOT NULL AUTO_INCREMENT, OfertaId int(10), CategoriaId int(10) NOT NULL, Nombre varchar(255), Precio float NOT NULL, Activo bit(1) NOT NULL, PRIMARY KEY (Id));
