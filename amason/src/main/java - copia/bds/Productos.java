...
public class Productos {
	...
	public Producto[] cargar_productos() throws PersistentException {
		//throw new UnsupportedOperationException();
		Producto[] productosA = null;
		//Producto productos = null;
		//List<Producto> productosL = null;
		//ArrayList<Producto> productosAL = null;
		
        PersistentTransaction t = basededatos.MDS12021PFOrtegaOrtegaPersistentManager.instance().getSession().beginTransaction();
        
        try {        	
        	//Producto[]
        	productosA = ProductoDAO.listProductoByQuery(null, null);
        	//Producto
        	//productos = ProductoDAO.loadProductoByQuery(null, null);
        	//List
        	//productosL = ProductoDAO.queryProducto(null, null);
        	//java.util.Iterator
        	//productos = ProductoDAO.iterateProductoByQuery(null, null);
