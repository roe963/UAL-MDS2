...
<vaadin-horizontal-layout class="content" style="width: 100%; height: 100%;">
 <vaadin-vertical-layout theme="spacing" id="vaadinVerticalLayout" style="flex-grow: 1; align-items: stretch; width: 100%; height: 100%; margin-right: var(--lumo-space-m); margin-left: var(--lumo-space-xl);" dir="layout-anadirUsuario">
  <vista-agregarempleado></vista-agregarempleado>
 </vaadin-vertical-layout>
 <vaadin-vertical-layout theme="spacing" style="width: 150%; height: 87%; flex-grow: 1;">
  <vaadin-horizontal-layout theme="spacing" style="height: 100%; width: 100%;">
   <vaadin-vertical-layout theme="spacing" style="flex-grow: 1; align-items: stretch; width: 100%; height: 100%; margin-right: var(--lumo-space-m); margin-left: var(--lumo-space-m);">
    ...
    <vaadin-horizontal-layout theme="spacing" id="layout-encargadoCompras" style="align-items: stretch;">
   ...
   <vaadin-vertical-layout theme="spacing" style="flex-grow: 1; align-items: stretch; width: 100%; height: 100%; margin-right: var(--lumo-space-xl); margin-left: var(--lumo-space-m);">
    ...
    <vaadin-horizontal-layout theme="spacing" id="layout-empresaTransportes" style="align-items: stretch;">
