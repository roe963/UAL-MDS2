...
<vaadin-vertical-layout theme="spacing" style="width: 100%; height: 100%;">
 ...
 <vaadin-vertical-layout style="flex-grow: 0; flex-shrink: 1; flex-basis: auto; align-self: stretch; margin-right: var(--lumo-space-xl); margin-bottom: var(--lumo-space-xs); margin-left: var(--lumo-space-xl); margin-top: var(--lumo-space-xs); padding-top: var(--lumo-space-m); padding-right: var(--lumo-space-xl); padding-left: var(--lumo-space-xl); border: 1px solid black; padding-bottom: var(--lumo-space-m);" id="vl_ofertas" class="content">
  <h3 style="align-self: center;">Ofertas</h3>
  <vaadin-horizontal-layout id="layout-ofertas" style="align-self: stretch; justify-content: center;"></vaadin-horizontal-layout>
 </vaadin-vertical-layout>
 <vaadin-vertical-layout class="content" style="flex-grow: 0; flex-shrink: 1; flex-basis: auto; align-self: stretch; margin-right: var(--lumo-space-xl); margin-bottom: var(--lumo-space-xs); margin-left: var(--lumo-space-xl); margin-top: var(--lumo-space-xs); padding-top: var(--lumo-space-m); padding-right: var(--lumo-space-xl); padding-left: var(--lumo-space-xl); border: 1px solid black; padding-bottom: var(--lumo-space-xl);">
  <h3 style="flex-grow: 0; align-self: center;">Top ventas</h3>
